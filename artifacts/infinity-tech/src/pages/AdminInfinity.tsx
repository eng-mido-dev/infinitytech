        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
          ...
          {pushStatus !== "unsupported" && (
            pushStatus === "subscribed" ? (
              ...
              <button
                onClick={subscribePush}
                title={t("Enable web push notifications", "تفعيل الإشعارات الفورية")}
                style={{ background: "rgba(34,211,238,0.07)", border: "1px solid rgba(34,211,238,0.2)", borderRadius: 8, padding: "5px 9px", cursor: "pointer", color: "hsl(188 86% 53% / 0.8)", display: "flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 600, transition: "background 0.18s ease, box-shadow 0.18s ease" }}
